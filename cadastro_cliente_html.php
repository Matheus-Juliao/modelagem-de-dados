<?php include('insert_cliente.php')?>
...
<html lang="pt">
    ...
    <body>
        ...
        <form class="container" action="cadastro_cliente_html.php" method="POST">
            <div class="form-group">
                <h1>Cadastro Bancário - Clientes</h1>
            </div>

            <div class="form-group">
                <h3 style="margin-top: 10px !important;">Dados Pessoais</h3>
            </div>
            ...
            <div class="form-group">
                <h3 style="margin-top: 10px !important;">Tipo de Conta</h3>
            </div>

            <?php
                require("config.php");
                $query = ("SELECT * FROM tipo_de_conta");
                $busca = mysqli_query($conexao, $query);
                while($dados = mysqli_fetch_array($busca)) {       
            ?>

                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tipo" id="tipo" value="<?php echo $dados['id_tipo'];?>">
                    <label class="form-check-label" for="tipo"><?php echo $dados['tipo'];?></label>
                </div>
            <?php }?>
